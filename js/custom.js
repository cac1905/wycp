    ...
    jQuery(document).ready(function() {
        ...
        function showHideMenu() {
            ...
            if ($carnaMobile.data('has-button') === true) {
                $button.on('click', function(event) {
                    $(this).parent().siblings('.mobile-wrap').stop(true, true).slideToggle(500, 'linear', function() {
                        whichTransitionEvent();
                    });
                    // $(this).parent().siblings('.mobile-wrap').css({
                ...
                if (tpj("#rev_slider_104_1").length) {
                    if (tpj("#rev_slider_104_1").revolution == undefined) {
                        ...
                        revapi104 = tpj("#rev_slider_104_1").show().revolution({
                            ...
                            fullScreenOffsetContainer: ".nav-wrap",
                            fullScreenOffset: "",
        ...
        **********************************************/
        ...
        function navHighLight() {
            ...
            $(window).on("load", getHighlLight);
            $(window).on("scroll", getHighlLight);
            ...
            if (!$('body').hasClass('no-animate')) {
                ...
                if ($(".animsition-overlay").length) {
                    ...
                    $(".animsition-overlay").animsition({
                        ...
                        linkElement: 'a:not([target="_blank"]):not([href^=\\#]):not([href^="ajax"]):not([class*="mag-popup"]):not([class*="ajax"]):not([class*="showhide"]):not([href^="javascript"]):not([class^="bx"]):not([class^="standard-popup"]):not([class*="mag-lightbox"]):not([data-popup]):not([class*="header-video__play-trigger"]):not([href*="mailto"])',
                        loading: true,
